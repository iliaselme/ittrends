sap.ui.jsview("sapui5.dashboardDashBoardTest.view.totalSubCategory", {

	getControllerName: function() {

		return "sapui5.dashboardDashBoardTest.controller.totalSubCategory";
	},
	...
	createContent: function(oController) {
		...
		var inputPage = new sap.m.Page({
			id: "masterSubCategoryPage",
			showNavButton: true,
			navButtonTap: [oController.eventTile, oController]
		});

		var list = new sap.m.List({
			id: "sListIdSubCategory"
		});

		var itemTemplate = new sap.m.StandardListItem({
			title: "{groupModel>docId}",
			info: "{groupModel>rmwwr} {groupModel>waers} ",
			description: "{groupModel>archiveDate}",
			type: "Active",
			press: function(evt) {
		...
		list.bindItems("groupModel>/", itemTemplate);
